    ...
    vector<int> maxActiveSectionsAfterTrade(string s,
        ...
        for (const vector<int>& query : queries) {
            ...
            const auto [startAdjacentGroupIndex, endAdjacentGroupIndex] =
                mapToAdjacentGroupIndices(zeroGroupIndex[l] + 1,
            ...
            if (s[l] == '0' && s[r] == '0' &&
                ...
                activeSections =
                    max(activeSections, ones + st.query(startAdjacentGroupIndex,
...
private:
    ...
    // Returns the indices of the adjacent groups that contain l and r
    // completely.
    //
